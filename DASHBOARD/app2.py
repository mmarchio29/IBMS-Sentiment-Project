...
app.layout = dbc.Container([
    html.Div([
        html.Div([
            html.H1([
                html.Span("Interactive Sentiment Analysis Dashboard")
            ]),
            html.
            P("This visualization shows the aggregated sentiment value of political keywords in media."
              )
        ],
